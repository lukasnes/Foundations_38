...
// CODE HERE
let bobsTotal = purchases.reduce((acc,currObj) => {
  if(currObj.owner === "Bob"){
...
let bobsFilter = purchases.filter((priceObj) => priceObj.owner === "Bob")
                          .reduce((acc,currObj) => acc + currObj.price,0)

console.log(bobsFilter)
console.log(bobsTotal)

let bobsPrices = purchases.map((priceObj) => {
  if(priceObj.owner === "Bob"){
